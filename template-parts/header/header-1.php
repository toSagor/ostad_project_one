<?php
   $header_open_hours = get_theme_mod('open_hours', __('Monday - Friday : 8:30 AM to 6:30 PM', 'solub')); 
   $header_button_title = get_theme_mod('cta_button_title', __('GET QUOTE NOW', 'solub'));
   $header_button_url = get_theme_mod('cta_button_link', __('#', 'solub'));
?>
...
<header class="tp-header-4-ptb">
   <?php if ( true == get_theme_mod( 'header_top_switch', 'on' ) ) : ?>
            ...
            <div class="col-md-6">
               <div class="tp-header-2-date">
                  <span><svg width="16" height="16" viewBox="0 0 16 16" fill="none" xmlns="http://www.w3.org/2000/svg">
                     ...
                     </svg><?php echo esc_html( $header_open_hours); ?></span>
               </div>
            </div>
            <?php endif; ?>
            <div class="col-md-6">
            ...
            <div class="tp-header-box d-flex align-items-center justify-content-between">
               ...
               <div class="tp-header-main-right d-flex align-items-center">
                     ...
                     <div id="tp-header-search" class="p-relative">
                        <form action="/" method="get">
                           <div class="tp-header-search-input">
                              <input type="text" name="s" id="search" value="<?php the_search_query(); ?>" placeholder="<?php echo esc_attr__('Search...', 'solub'); ?>">
                           </div>
                  ...
                  <div class="tp-header-2-main-right-btn d-none d-lg-block">
                     <a href="<?php echo esc_url($header_button_url); ?>" class="tp-btn orange">
                        <span><svg width="22" height="22" viewBox="0 0 22 22" fill="none" xmlns="http://www.w3.org/2000/svg">
                           ...
                           </svg></span><?php echo esc_html($header_button_title); ?>
                     </a>
                  </div>
                  <?php endif; ?>
